...
const TYPES_ALLOWED_ARRAY:PackedInt32Array = [
	TYPE_BOOL,
	TYPE_INT,
	TYPE_FLOAT,
	TYPE_STRING,
...
var type:TYPES_ALLOWED = TYPES_ALLOWED.TYPE_INT : set=set_type
func get_type()->int:return TYPES_ALLOWED_ARRAY[type]
...
func get_property_list_settings()->Array[Dictionary]:
	...
	properties.append({
		...
		"hint_string": ','.join(TYPES_ALLOWED.keys()),
